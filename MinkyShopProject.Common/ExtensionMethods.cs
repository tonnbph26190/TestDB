...
namespace MinkyShopProject.Common
{
    ...
    public static class ExtensionMethods
    {
        ...
        // public static Pagination<T> GetPage<T>(this IMongoCollection<T> collection, PaginationRequest query) where T : class
        // {
        ...
        //         var sortDefinition = Builders<T>.Sort.Descending(query.Sort);
        //
        //         // Get total number of documents
        //         var totalCount = collection.CountDocuments(filter);
        //
        //         // Calculate total pages
        //         var totalPages = (int)Math.Ceiling(totalCount / (float)query.Size.Value);
        //
